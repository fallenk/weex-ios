//
//  ETKSkinCareMessageController.m
//  WeexiOS
//
...
#import "ETKSkinCareMessageController.h"

@interface ETKSkinCareMessageController ()
@property (nonatomic, strong) WXSDKInstance *instance;
@property (nonatomic, strong) UIView *weexView;

@end

@implementation ETKSkinCareMessageController
...
- (void)p_initWeexView {
    ...
    NSString *fileName = @"input-test.we";
